...
gene_orders_all_fn = "2023-06-02_gene_orders_all_v1.txt"


unzipTF = TRUE
list_of_protIDs_in_genome = list()
cat("\nMerging feature tables from ", length(genome_dirs), " genome directories...\n")
...
system(paste0("open ", gene_orders_all_fn))