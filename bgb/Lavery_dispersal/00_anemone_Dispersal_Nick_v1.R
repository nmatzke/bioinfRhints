...
wd = np("/GitHub/bioinfRhints/bgb/Lavery_dispersal/")
setwd(wd)
...
pdffn = "Anemone_Dispersal_DEC_vs_DEC+J.pdf"        ####anemone
...
pdffn = "Anemone_Dispersal_DIVALIKE_vs_DIVALIKE+J.pdf"       ###anemone
pdf(pdffn, width=12, height=12)
...
pdffn = "Anemone_Dispersal_BAYAREALIKE_vs_BAYAREALIKE+J.pdf"      #######
pdf(pdffn, width=12, height=12)
...
pdffn = "per-area_probabilities_anemones_Dispersal_all6_models_v1_wColor.pdf"
