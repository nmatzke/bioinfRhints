...
trfn = "anemone tree-newick.txt"     ###anemone
...
geogfn = "anemone geog data.txt"         ###anemone
...
BioGeoBEARS_run_object$timesfn = "anemone1 timeperiods.txt"      ####anemone

#BioGeoBEARS_run_object$dispersal_multipliers_fn = "manual_dispersal_multipliers.txt"
#BioGeoBEARS_run_object$dispersal_multipliers_fn ="dispersal_matrix_NI_H0.txt"      #################
BioGeoBEARS_run_object$dispersal_multipliers_fn ="anemone dispersal matrix A.txt"      ###anemone
...
analysis_titletxt ="BioGeoBEARS DEC on Test1"      ###########
...
#######################################################
analysis_titletxt ="BioGeoBEARS DEC+J on Test1"     #######
...
analysis_titletxt ="BioGeoBEARS DIVALIKE on Test1"    #####
...
analysis_titletxt ="BioGeoBEARS DIVALIKE+J on Test1"     ######
...
analysis_titletxt ="BioGeoBEARS BAYAREALIKE on Test1"      ######
...
analysis_titletxt ="BioGeoBEARS BAYAREALIKE+J on Test1"     ######
