...
wd = "/GitHub/bioinfRhints/bgb/cinthy/3areas_M0/"
setwd(wd)
...
tr
plot(tr)
title("Epacrids phylogeny from Cinthy & Caroline (edited by NJM)")
...
# This is the example geography file for Hawaiian Epacrids
# (from Ree & Smith 2008)
geogfn = "geog.data"
...
runslow = TRUE
resfn = "Epacrids_DEC_M0_unconstrained_v1.Rdata"
if (runslow)
    {
...
resfn = "Epacrids_DEC+J_M0_unconstrained_v1.Rdata"
runslow = TRUE
if (runslow)
    {
...
# PDF plots
#######################################################
pdffn = "Epacrids_DEC_vs_DEC+J_M0_unconstrained_v1.pdf"
pdf(pdffn, height=18, width=10)

#######################################################
# Plot ancestral states - DEC
#######################################################
analysis_titletxt ="BioGeoBEARS DEC on Epacrids M0_unconstrained"
...
#######################################################
analysis_titletxt ="BioGeoBEARS DEC+J on Epacrids M0_unconstrained"
...
runslow = TRUE
resfn = "Epacrids_DIVALIKE_M0_unconstrained_v1.Rdata"
if (runslow)
    {
    res = bears_optim_run(BioGeoBEARS_run_object)
    res    
...
resfn = "Epacrids_DIVALIKE+J_M0_unconstrained_v1.Rdata"
runslow = TRUE
if (runslow)
    {
    #sourceall("/Dropbox/_njm/__packages/BioGeoBEARS_setup/")
...
pdffn = "Epacrids_DIVALIKE_vs_DIVALIKE+J_M0_unconstrained_v1.pdf"
pdf(pdffn, height=18, width=10)

#######################################################
# Plot ancestral states - DIVALIKE
#######################################################
analysis_titletxt ="BioGeoBEARS DIVALIKE on Epacrids M0_unconstrained"
...
#######################################################
analysis_titletxt ="BioGeoBEARS DIVALIKE+J on Epacrids M0_unconstrained"
...
runslow = TRUE
resfn = "Epacrids_BAYAREALIKE_M0_unconstrained_v1.Rdata"
if (runslow)
    {
    res = bears_optim_run(BioGeoBEARS_run_object)
    res    
...
resfn = "Epacrids_BAYAREALIKE+J_M0_unconstrained_v1.Rdata"
runslow = TRUE
if (runslow)
    {
    res = bears_optim_run(BioGeoBEARS_run_object)
...
pdffn = "Epacrids_BAYAREALIKE_vs_BAYAREALIKE+J_M0_unconstrained_v1.pdf"
pdf(pdffn, height=18, width=10)

#######################################################
# Plot ancestral states - BAYAREALIKE
#######################################################
analysis_titletxt ="BioGeoBEARS BAYAREALIKE on Epacrids M0_unconstrained"
...
#######################################################
analysis_titletxt ="BioGeoBEARS BAYAREALIKE+J on Epacrids M0_unconstrained"
