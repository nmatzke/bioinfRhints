...
# Check that it works in a division
timewidths_by_state0 = count_brlen_in_each_state(timeperiods=c(0.012,2), res, trtable, clado_events_table, ana_events_table)
head(timewidths_by_state0)
tail(timewidths_by_state0)
...
timewidths_by_state1 = count_brlen_in_each_state(timeperiods=c(0.012,2), res, trtable, clado_events_table, ana_events_table)
head(timewidths_by_state1)
tail(timewidths_by_state1)
...
for (i in 1:length(trait_RES_clado_events_tables))
	...
	timewidths_by_state1 = count_brlen_in_each_state(timeperiods=c(38,40), res, trtable, clado_events_table, ana_events_table)
	head(timewidths_by_state1)
	tail(timewidths_by_state1)
	...
	clado_events_tables=clado_events_tables_wTrait_state1; 	
	ana_events_tables=ana_events_tables_wTrait_state1;
	areanames=areanames;
	actual_names=areanames;
	timeperiod=c(0.012,2)
	counts_bodysize1 = count_ana_clado_events(clado_events_tables=clado_events_tables_wTrait_state1, ana_events_tables=ana_events_tables_wTrait_state1, areanames=areanames, actual_names=areanames, timeperiod=c(0.012,2)) 

	#clado_events_tables=clado_events_tables_wTrait_state2; ana_events_tables=ana_events_tables_wTrait_state2; areanames=areanames; actual_names=areanames; timeperiod=timeperiods
	counts_bodysize2 = count_ana_clado_events(clado_events_tables=clado_events_tables_wTrait_state2, ana_events_tables=ana_events_tables_wTrait_state2, areanames=areanames, actual_names=areanames, timeperiod=c(38,40)) 
